...
import (
	...
	"github.com/adcoutinho/go-rest-api/pkg/swagger/server/restapi"
	"github.com/adcoutinho/go-rest-api/pkg/swagger/server/restapi/operations"
...
func main() {
	...
	// Simple Example of server start
	/*
